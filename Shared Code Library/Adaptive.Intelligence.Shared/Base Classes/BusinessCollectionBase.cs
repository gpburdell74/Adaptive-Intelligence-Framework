...
namespace Adaptive.Intelligence.Shared
{
	...
	/// <seealso cref="List{T}"/>
	public class BusinessCollectionBase<T> : List<T> where T : BusinessBase
	{
		...
		/// <summary>
		/// Finalizes an instance of the <see cref="BusinessCollectionBase{T}"/> class.
		/// </summary>
		...
		/// <summary>
		/// Removes the first occurrence of a specific object from the <see cref="BusinessCollectionBase{T}"/>.
		/// </summary>
