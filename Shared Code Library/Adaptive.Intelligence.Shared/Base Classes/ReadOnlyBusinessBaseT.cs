...
namespace Adaptive.Intelligence.Shared
{
	...
	/// </typeparam>
	public abstract class ReadOnlyBusinessBase<T> : PropertyAwareBase, IValidatableObject
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ReadOnlyBusinessBase{T}"/> class.
		/// </summary>
		/// <remarks>
		/// This is the default constructor.
		/// </remarks>
		protected ReadOnlyBusinessBase()
		{
		...
		protected ReadOnlyBusinessBase(T entity)
		{
			_entity = entity;
		}
		/// <summary>
