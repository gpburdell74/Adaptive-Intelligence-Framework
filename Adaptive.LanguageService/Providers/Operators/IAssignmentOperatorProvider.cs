...
/// <summary>
/// Provides the signature definition for implementations that define the list of assignment operators.
/// </summary>
/// <seealso cref="ICodeProvider"/>
public interface IAssignmentOperatorProvider : ICodeProvider
{
    /// <summary>
