...
/// <summary>
/// Provides the signature definition for implementations that define the list of logical operators.
/// </summary>
/// <seealso cref="ICodeProvider"/>
public interface ILogicalOperatorProvider : ICodeProvider
{
    /// <summary>
