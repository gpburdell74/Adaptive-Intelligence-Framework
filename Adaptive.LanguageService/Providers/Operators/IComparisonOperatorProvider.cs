...
/// <summary>
/// Provides the signature definition for implementations that define the list of comparison operators.
/// </summary>
/// <seealso cref="ICodeProvider"/>
public interface IComparisonOperatorProvider : ICodeProvider
{
    /// <summary>
