...
/// <summary>
/// Provides the signature definition for implementations that define the list of arithmetic operators.
/// </summary>
/// <seealso cref="ICodeProvider"/>
public interface IMathOperatorProvider : ICodeProvider
{
    /// <summary>
