...
/// <summary>
/// Provides the signature definition for implementations that define the list of "operation" operators.
/// </summary>
/// <seealso cref="ICodeProvider"/>
public interface IOperationOperatorProvider : ICodeProvider
{
    /// <summary>
