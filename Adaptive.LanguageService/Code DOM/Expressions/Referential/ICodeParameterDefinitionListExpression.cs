...
/// of expressions that define parameters for a procedure or function.
/// </summary>
/// <seealso cref="ICodeExpression" />
public interface ICodeParameterDefinitionListExpression : ICodeExpression
{
    ...
    /// </value>
    public List<ICodeParameterDefinitionExpression>? ParameterList { get; }
    #endregion
}