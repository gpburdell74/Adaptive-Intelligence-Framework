...
{
    /// <summary>
    /// Represents and manages the file header for TAZ file.
    /// </summary>
    ...
    public sealed class TazFileHeader : ExceptionTrackingBase, IBinarySerializable
    {
        ...
        /// <summary>
        /// Gets or sets the directory starting position.
        /// </summary>
        /// <value>
        ...
        /// <summary>
        /// Gets a value indicating whether the file is an actual TAZ file.
        /// </summary>
        /// <value>
        ///   <c>true</c> if this instance is a TAZ file; otherwise, <c>false</c>.
        /// </value>
        ...
        /// </param>
        /// <returns>
        /// If successful, returns a <see cref="TazFileHeader"/> instance containing the header data;
        ...
        public static TazFileHeader? ReadFromOpenFile(ISafeBinaryReader reader)
        {
            ...
            if (data != null && data.Length == FileSpecConstants.FileHeaderLength)
            {
                header = new TazFileHeader(
                    data[0], data[1], data[2],      // Application indicator.
