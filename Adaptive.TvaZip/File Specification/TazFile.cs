...
namespace Adaptive.Taz
{
	...
	public sealed class TazFile : ExceptionTrackingBase
	{
		...
		/// </summary>
		/// <param name="fileName">
		/// A string containing the fully-qualfied path and name of the file.
		/// </param>
		...
		/// AN integer specifying the orinal index of the file.
		/// </param>
		/// <param name="length">
		...
		private async Task<long> PerformFileCompressionOperationAsync(string fileToCompress, ITazContentWriter writer)
		{
			...
			if (operation.IsValid)
			{
				...
				{
					// Create and store the directoruy entry.
