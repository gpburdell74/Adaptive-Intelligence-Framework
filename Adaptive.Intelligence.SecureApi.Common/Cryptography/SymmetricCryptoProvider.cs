...
/// <summary>
/// Provides the standard symmetric cryptographic provider for the secure API system.
/// </summary>
/// <seealso cref="DisposableObjectBase" />
/// <seealso cref="ISymmetricCryptoProvider" />
public class SymmetricCryptoProvider : DisposableObjectBase, ISymmetricCryptoProvider
{
    ...
    /// </param>
    public SymmetricCryptoProvider(IEnumerable<byte[]> keyData)
    {
        // Create the engine.
        _aes = new AesProvider();
