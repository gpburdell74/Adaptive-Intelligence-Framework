...
namespace Adaptive.Intelligence.SecureApi.Common.Cryptography.Symmetric;

/// <summary>
/// Provides the standard AES cryptographic provider for the secure API system.
/// </summary>
/// <seealso cref="DisposableObjectBase" />
/// <seealso cref="ISymmetricCryptoProvider" />
public class AesCryptoProvider : DisposableObjectBase, ISymmetricCryptoProvider
{
    ...
    /// </param>
    public AesCryptoProvider(IEnumerable<byte[]> keyData)
    {
        // Create the engine.
        _aes = new AesProvider();
