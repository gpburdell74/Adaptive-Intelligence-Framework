...
namespace Adaptive.Intelligence.SecureApi.Cryptography.Symmetric;

/// <summary>
/// Provides the base definition for a standard symmetric cryptographic provider implementation for the 
/// secure API system.
/// </summary>
/// <seealso cref="DisposableObjectBase" />
/// <seealso cref="ISymmetricCryptoProvider" />
public abstract class SymmetricCryptoProviderBase : DisposableObjectBase, ISymmetricCryptoProvider
{
    #region Private Member Declarations
    /// <summary>
    /// The list of key store instances.
    /// </summary>
    private List<ISymmetricKeyStore>? _keyStore;
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SymmetricCryptoProviderBase"/> class.
    /// </summary>
    /// <remarks>
    /// This is the default constructor.
    /// </remarks>
    protected SymmetricCryptoProviderBase()
    {
        // Create the engine.
        ...
        _keyStore = new List<ISymmetricKeyStore>();
    ...
    /// </param>
    public SymmetricCryptoProviderBase(IEnumerable<byte[]> keyData)
    {
        // Create the engine.
        _aes = new AesProvider();
    ...
    public byte[]? Decrypt(byte[]? encryptedData, int keySequence)
    {
        ...
        _aes.SetKeyIV(_keyStore[keySequence].ConcatenateKeyIVData());
