...
public class BlazorBasicComplexExpression : BasicExpression, ICodeExpression
{
    #region Constructors
    /// <summary>
    ...
    /// </summary>
    /// <value>
    /// A <see cref="List{T}"/> of <see cref="BasicExpression"/> enumerated value indicating the data type.
    /// </value>
    public List<BasicExpression> Expressions { get; set; } = new List<BasicExpression>();
    #endregion
    ...
    {
        int index = 0;
        object initEval = Expressions[index].Evaluate(engine, environment, scope);
        ...
        do
        {
            ...
            index++;
            object abc = Expressions[index].Evaluate(engine, environment, scope);
    ...
    public override string? Render()
    {
        ...
        builder.Append("(");
        foreach(BasicExpression expression in Expressions)
        {
