...
/// <summary>
/// Provides a two-way look-up dictionary for logical operators.
/// </summary>
/// <seealso cref="TwoWayDictionaryBase{PrimaryValue, SecondaryValue}" />
/// <seealso cref="ILogicalOperatorDictionary{T}" />
public sealed class BlazorBasicLogicalOperatorDictionary : TwoWayDictionaryBase<string, BlazorBasicLogicalOperators>, ILogicalOperatorDictionary<BlazorBasicLogicalOperators>
{
    #region Constructor
    /// <summary>
    /// Initializes a new instance of the <see cref="BlazorBasicLogicalOperatorDictionary"/> class.
    /// </summary>
    /// <remarks>
    /// This is the default constructor.
    /// </remarks>
    public BlazorBasicLogicalOperatorDictionary()
    {
    }
    #endregion
    ...
    /// </param>
    /// <returns>
    /// A <see cref="BlazorBasicLogicalOperators" /> enumerated value indicating the operator.
    /// </returns>
    public BlazorBasicLogicalOperators GetOperator(string? operatorText)
    {
    ...
    /// </returns>
    public string? GetOperatorText(BlazorBasicLogicalOperators operatorId)
    {
    ...
    /// </summary>
    /// <param name="provider">The <see cref="ILogicalOperatorProvider" /> provider instance used to provide the list.
    /// </param>
    public void InitializeDictionary(ILogicalOperatorProvider provider)
    {
        ...
        List<BlazorBasicLogicalOperators> typeList = IdsToEnum<BlazorBasicLogicalOperators>(idValues);
        idValues.Clear();
    ...
    /// </returns>
    public bool IsLogicalOperator(string? code)
    {
