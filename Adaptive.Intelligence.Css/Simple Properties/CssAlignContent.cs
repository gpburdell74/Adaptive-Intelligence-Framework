...
namespace Adaptive.Intelligence.Css
{
	...
	public sealed class CssAlignContent : DisposableObjectBase, ICssProperty
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CssAlignContent"/> class.
		/// </summary>
		/// <remarks>
		...
		/// </param>
		public CssAlignContent(AlignContentOption? alignmentValue)
		{
		...
		/// </param>
		public CssAlignContent(string cssDefinition)
		{
