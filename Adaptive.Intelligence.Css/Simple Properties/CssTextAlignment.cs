...
namespace Adaptive.Intelligence.Css
{
	...
	public sealed class CssTextAlignment : DisposableObjectBase, ICssProperty
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CssTextAlignment"/> class.
		/// </summary>
		/// <remarks>
		/// This is the default constructor.
		/// </remarks>
		public CssTextAlignment()
		{
		...
		/// A <see cref="TextAlignment"/> enumerated value, or <b>null</b> if not set.
		/// </param>
		public CssTextAlignment(TextAlignment? alignmentValue)
		{
		...
		/// </value>
		public bool CanRender => _alignment != null && _alignment != TextAlignment.NotSpecified;
		/// <summary>
		...
		public void ParseCss(string? cssDefinition)
		{
			...
			{
				_alignment = TextAlignmentConverter.FromText(cssDefinition);
			}
		}
		/// <summary>
		/// Converts to css.
		...
		public string ToCss()
		{
			...
			if (_alignment != null && _alignment.Value != TextAlignment.NotSpecified)
			{
				builder.Append(CssPropertyNames.TextAlign + CssLiterals.CssSeparator + CssLiterals.Space +
					TextAlignmentConverter.ToText(_alignment.Value));
			}
