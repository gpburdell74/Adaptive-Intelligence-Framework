...
{
	/// <summary>
	/// Contains a definition of a max-height property.
	/// </summary>
	/// <seealso cref="DisposableObjectBase" />
	public sealed class CssMaxHeight : DisposableObjectBase, ICssProperty
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CssMaxHeight"/> class.
		/// </summary>
		/// <param name="options">
		/// The <see cref="MaxHeightOptions"/> enumerated value indicating which type of Max-height specification is used.
		/// </param>
		public CssMaxHeight()
		{
		}
		...
		/// </param>
		public CssMaxHeight(string cssSpecification)
		{
		...
		/// </summary>
		/// <param name="value">
		/// A <see cref="float"/> specifying the Max height value.
		/// </param>
		public CssMaxHeight(float value)
		{
		...
		/// </param>
		public CssMaxHeight(float value, CssUnit unit)
		{
		...
		/// </summary>
		/// <value>
		/// A <see cref="FloatWithUnit"/> instance describing the Max height as a value and optional unit,
		...
		public string ToCss()
		{
			...
			if (CanRender)
			{
				builder.Append(CssPropertyNames.MaxHeight + CssLiterals.CssSeparator + CssLiterals.Space);
