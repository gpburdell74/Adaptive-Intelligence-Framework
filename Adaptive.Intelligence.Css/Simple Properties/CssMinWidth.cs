...
{
	/// <summary>
	/// Contains a definition of a min-width property.
	/// </summary>
	/// <seealso cref="DisposableObjectBase" />
	public sealed class CssMinWidth : DisposableObjectBase, ICssProperty
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CssMinWidth"/> class.
		/// </summary>
		/// <param name="options">
		/// The <see cref="MinWidthOptions"/> enumerated value indicating which type of Min-width specification is used.
		/// </param>
		public CssMinWidth()
		{
		}
		...
		/// </param>
		public CssMinWidth(string cssSpecification)
		{
		...
		/// </summary>
		/// <param name="value">
		/// A <see cref="float"/> specifying the Min width value.
		/// </param>
		public CssMinWidth(float value)
		{
		...
		/// </param>
		public CssMinWidth(float value, CssUnit unit)
		{
		...
		/// </summary>
		/// <value>
		/// A <see cref="FloatWithUnit"/> instance describing the Min width as a value and optional unit,
		...
		public string ToCss()
		{
			...
			if (CanRender)
			{
				builder.Append(CssPropertyNames.MinWidth + CssLiterals.CssSeparator + CssLiterals.Space);
