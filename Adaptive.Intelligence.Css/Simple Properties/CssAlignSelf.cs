...
{
	/// <summary>
	/// Represents a CSS align-self property.
	/// </summary>
	/// <seealso cref="DisposableObjectBase" />
	public sealed class CssAlignSelf : DisposableObjectBase, ICssProperty
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CssAlignSelf"/> class.
		/// </summary>
		/// <remarks>
		...
		/// </param>
		public CssAlignSelf(AlignContentOption? alignmentValue)
		{
		...
		/// </param>
		public CssAlignSelf(string cssDefinition)
		{
		...
		public string ToCss()
		{
			...
			{
				builder.Append(CssPropertyNames.AlignContent + CssLiterals.CssSeparator + CssLiterals.Space + AlignContentOptionConverter.ToText(_alignment.Value));
			}
