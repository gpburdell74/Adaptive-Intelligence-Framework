...
partial class AddEditPanelTemplateDialog
{
    /// <summary>
    ...
    {
        var resources = new System.ComponentModel.ComponentResourceManager(typeof(AddEditPanelTemplateDialog));
        ...
        Editor = new PanelTemplateEditorControl();
        ...
        SaveCancelPanel.Location = new Point(0, 439);
        SaveCancelPanel.Name = "SaveCancelPanel";
        SaveCancelPanel.Size = new Size(996, 42);
        ...
        SavePanel.Location = new Point(546, 0);
        ...
        SaveAsPanel.Location = new Point(696, 0);
        ...
        ClosePanel.Location = new Point(846, 0);
        ...
        Editor.Font = new Font("Segoe UI", 9.75F);
        Editor.Location = new Point(0, 0);
        Editor.Name = "Editor";
        Editor.Size = new Size(996, 439);
        Editor.TabIndex = 0;
        // 
        // AddEditPanelTemplateDialog
        // 
        AutoScaleDimensions = new SizeF(7F, 17F);
        AutoScaleMode = AutoScaleMode.Font;
        ClientSize = new Size(996, 481);
        ControlBox = false;
        Controls.Add(Editor);
        ...
        KeyPreview = true;
        Name = "AddEditPanelTemplateDialog";
        StartPosition = FormStartPosition.CenterScreen;
        Text = "Edit Gradient Panel Template";
    ...
    private PanelTemplateEditorControl Editor;
}