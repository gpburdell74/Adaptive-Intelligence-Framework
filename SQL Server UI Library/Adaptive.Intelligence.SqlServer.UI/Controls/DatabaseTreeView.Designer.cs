namespace Adaptive.Intelligence.SqlServer.UI
{
    partial class DatabaseTreeView
    {
        ...
        private void InitializeComponent()
        {
            ...
            TableMenuGenGetForCustomer = new ToolStripMenuItem();
            ...
            // TableMenu
            // 
            TableMenu.Items.AddRange(new ToolStripItem[] { TableMenuGenGetAll, TableMenuGenGetById, TableMenuGenGetForCustomer, TableMenuGenInsert, TableMenuGenUpdate, TableMenuGenDelete, TableMenuGenSpDiv, TableMenuGenAllSp, TableMenuGenAllDiv, TableMenuGenDataDefinition, TableMenuGenDataAccess, TableMenuGenClassesDiv, TableMenuGenEditProfile, TableMenuGenEditDiv, TableMenuScriptCreate });
            ...
            // 
            // TableMenuGenGetForCustomer
            // 
            TableMenuGenGetForCustomer.Name = "TableMenuGenGetForCustomer";
            TableMenuGenGetForCustomer.Size = new Size(311, 22);
            TableMenuGenGetForCustomer.Text = "Generate Get For Customer Stored Procedure";
            TableMenuGenGetForCustomer.ToolTipText = "Generates the standard CRUD stored procedure for retrieving the records from the table for a specified customer.";
            // 
            // TableMenuGenInsert
            // 
        ...
        private System.Windows.Forms.ToolStripMenuItem TableMenuGenGetForCustomer;
