...
/// <summary>
/// Provides an ellipsis button control that can be used to open a file dialog for selecting a file to 
/// open. This control is typically used in conjunction with a text box to allow users to browse for a 
/// file and display the selected file path in the text box.
/// </summary>
/// <seealso cref="AIButton" />
/// <seealso cref="OpenFileDialog" />
public class FileOpenEllipseButton : AIButton, IOpenFileProfile
{
    ...
    /// <summary>
    /// The profile containing the parameters for the Open File dialog.
    /// </summary>
    private IOpenFileProfile _profile = new OpenFileProfile();
    #endregion

    #region Constructor / Dispose Methods
    /// <summary>
    /// Initializes a new instance of the <see cref="FileOpenEllipseButton"/> class.
    /// </summary>
    /// <remarks>
    /// This is the default constructor.
    /// </remarks>
    public FileOpenEllipseButton()
    {
        _profile = new OpenFileProfile();
        InitializeComponent();
    }
    ...
    [Browsable(true),
        Description(""),
     DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
    public bool Multiselect { get => _profile.Multiselect; set =>_profile.Multiselect = value; }
    ...
    [Browsable(true),
        Description(""),
     DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
    public bool ReadOnlyChecked { get => _profile.ReadOnlyChecked; set =>_profile.ReadOnlyChecked = value; }
    ...
    /// </value>
    [Browsable(true),
        Description("Gets or sets a value indicating whether the dialog box allows to select read-only files."),
     DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
    public bool SelectReadOnly { get => _profile.SelectReadOnly; set =>_profile.SelectReadOnly = value; }
    ...
    /// </value>
    [Browsable(true),
        Description("Gets or sets a value indicating whether the dialog box shows a preview for selected files."),
     DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
    public bool ShowPreview { get => _profile.ShowPreview; set =>_profile.ShowPreview = value; }
    ...
    /// </value>
    [Browsable(true),
        Description("Gets or sets a value indicating whether the dialog contains a read-only check box."),
     DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
    public bool ShowReadOnly { get => _profile.ShowReadOnly; set =>_profile.ShowReadOnly = value; }
    ...
    protected override void OnClick(EventArgs e)
    {
        if (_profile != null)
        {
            CommonDialogProvider.GetFileToOpen(_profile);
        }
        base.OnClick(e);
    }
    #endregion
