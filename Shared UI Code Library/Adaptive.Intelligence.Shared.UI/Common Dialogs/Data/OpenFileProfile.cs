...
public class OpenFileProfile : DisposableObjectBase, IOpenFileProfile
{
    /// <summary>
    ...
    /// </summary>
    /// <returns>
    /// A new <see cref="OpenFileProfile"/> that is a copy of this instance.
    /// </returns>
    public OpenFileProfile Clone()
    {
        return new OpenFileProfile
        {
